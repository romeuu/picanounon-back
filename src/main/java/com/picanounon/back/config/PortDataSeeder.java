        ...
        return args -> {
            ...
            if (needsReseed) {
                ...
                List<Port> initialPorts = List.of(
                        ...
                        new Port(null, 5, "Marín", "Marín", Zone.RIAS_BAIXAS, 42.3941, -8.7025, "Vigo", 10),
                        ...
                        new Port(null, 5, "Ribeira", "Ribeira", Zone.RIAS_BAIXAS, 42.5539, -8.9931, "Vilagarcía", -5),
                        new Port(null, 5, "Aguiño", "Aguiño", Zone.RIAS_BAIXAS, 42.5233, -9.0189, "Vilagarcía", -5),
                        ...
                        new Port(null, 4, "O Pindo", "O Pindo (Carnota)", Zone.COSTA_DA_MORTE, 42.8986, -9.1239, "Vilagarcía", 5),
                        new Port(null, 4, "O Ézaro", "O Ézaro", Zone.COSTA_DA_MORTE, 42.9097, -9.1308, "Vilagarcía", 5),
                        new Port(null, 4, "Corcubión", "Corcubión", Zone.COSTA_DA_MORTE, 42.9431, -9.1919, "Vilagarcía", 5),
                        new Port(null, 4, "Fisterra", "Fisterra (Cabo)", Zone.COSTA_DA_MORTE, 42.9083, -9.268, "Vilagarcía", 6),
                        ...
                        new Port(null, 1, "O Vicedo", "O Vicedo", Zone.CANTABRICO, 43.7336, -7.6719, "Ferrol Porto Exterior", 12),
                        new Port(null, 1, "Celeiro", "Celeiro (Viveiro)", Zone.CANTABRICO, 43.68, -7.595, "Ferrol Porto Exterior", 14),
                        new Port(null, 1, "Burela", "Burela", Zone.CANTABRICO, 43.6592, -7.3517, "Ferrol Porto Exterior", 15),
                        new Port(null, 1, "Foz", "Foz", Zone.CANTABRICO, 43.5697, -7.2556, "Ferrol Porto Exterior", 18),
                        new Port(null, 1, "Rinlo", "Rinlo", Zone.CANTABRICO, 43.5558, -7.1075, "Ferrol Porto Exterior", 20),
                        new Port(null, 1, "Porcillán", "Ribadeo (Porcillán)", Zone.CANTABRICO, 43.5357, -7.0403, "Ferrol Porto Exterior", 22)
                );
